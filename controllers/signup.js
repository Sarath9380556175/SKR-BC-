...
exports.signup=(req,res)=>{
    ...
    var transporter = nodemailer.createTransport({
      ...
      var mailOptions = {
        from: 'sarathbunny50@gmail.com',
        to: email,
        subject: `${name} successfully created account in our application`,
        text: `Welcome ${name}`
      };
   ...
   console.log(users)
   users.save()
   .then(response=>{res.status(200).json({message:"user registerd successfully", signup:response})})
